...
do
    ...
    PARAMS="
      ...
      --graph_params area_red=True pre_point_out=False
...
"#      --gpu_devices $GPU
    ...
    TS_SOCKET=${QUEUE} tsp PYTHONPATH=/home/$USER/devel/projects/projectneiss2d/tf_neiss:$PYTHONPATH python -u ./tf_neiss/trainer/trainer_types/trainer_2dt/trainer_triangle2d.py ${PARAMS} "$@"
#    LAV_PARAMS="
#      --val_list lists/${DATASET}_val.lst
