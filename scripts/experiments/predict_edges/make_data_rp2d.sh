...
# example call: $> sh ./tf_neiss/scripts/experiments/predict_edges/make_data_rp2d.sh rp2d_3to7edge --max_edges 7
# example call: $> sh ./tf_neiss/scripts/experiments/predict_edges/make_data_rp2d.sh rp2d_3to12edge --max_edges 12
