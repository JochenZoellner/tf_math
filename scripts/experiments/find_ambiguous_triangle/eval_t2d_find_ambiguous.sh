...
sh ./tf_neiss/scripts/experiments/find_ambiguous_triangle/eval_t2d_find_ambiguous.sh FA_reference_lr0.0002_lrd0.98 1 --plot_params select=1 select_counter=200 filename=select1.pdf &
