...
sh ./tf_neiss/scripts/experiments/find_ambiguous_triangle/train_t2d_find_ambiguous_full_circle.sh FA_absolute_s_norm_FC_reference_lr0.0002_lrd0.98_swish 0 --optimizer_params learning_rate=0.0002 lr_decay_rate=0.98 --graph_params ff_activation=swish abs_only=True --loss_mode input_diff_s_norm,show_best_point_diff
sh ./tf_neiss/scripts/experiments/find_ambiguous_triangle/train_t2d_find_ambiguous_full_circle.sh FA_absolute_s_norm_FC_reference_lr0.0002_lrd0.98 0 --optimizer_params learning_rate=0.0002 lr_decay_rate=0.98 --graph_params abs_only=True --loss_mode input_diff_s_norm,show_best_point_diff
