...
sh ./tf_neiss/scripts/experiments/find_ambiguous_triangle/eval_t2d_find_ambiguous_full_circle.sh FA_absolute_s_norm_FC_reference_lr0.0002_lrd0.98_swish 0 --plot_params select=1 select_counter=200 filename=select1.pdf &
sh ./tf_neiss/scripts/experiments/find_ambiguous_triangle/eval_t2d_find_ambiguous_full_circle.sh FA_absolute_s_norm_FC_reference_lr0.0002_lrd0.98 0 --plot_params select=1 select_counter=200 filename=select1.pdf &
sh ./tf_neiss/scripts/experiments/find_ambiguous_triangle/eval_t2d_find_ambiguous_full_circle.sh FA_s_norm_FC_reference_lr0.0002_lrd0.98_swish 0 --plot_params select=1 select_counter=200 filename=select1.pdf &
sh ./tf_neiss/scripts/experiments/find_ambiguous_triangle/eval_t2d_find_ambiguous_full_circle.sh FA_s_norm_FC_reference_lr0.0002_lrd0.98 0 --plot_params select=1 select_counter=200 filename=select1.pdf &
////