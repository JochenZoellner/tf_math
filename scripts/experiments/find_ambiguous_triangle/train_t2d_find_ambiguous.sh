...
sh ./tf_neiss/scripts/experiments/find_ambiguous_triangle/train_t2d_find_ambiguous.sh FA_reference_lr0.0002_lrd0.98 0 --optimizer_params learning_rate=0.0002 lr_decay_rate=0.98
