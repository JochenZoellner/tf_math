...
for parameter in 5.0 10.0 12.5 15.0 17.5 20.0 22.5 25.0 26.0 27.0 27.5 28.0 29.0 30.0 31.0 32.0 32.5 33.0 34.0 35.0 \
36.0 37.0 37.5 38.0 39.0 40.0 41.0 42.0 42.5 43.0 44.0 45.0 46.0 47.0 48.0 49.0 50.0 55.0 60.0 65.0 70.0 80.0 90.0 \
100.0 110.0 120.0 130.0 140.0 150.0 160.0 170.0 175.0 180.0
do
    ...
    PARAMS="
      ...
      --input_params max_fov=${parameter} min_fov=0.0
